...
public class FileExplorerTabActivity extends Activity {
     ...
     * 这是一个帮助类实现了tab 的管理和ViewPager连接Tbahost 的所有细节
     * It relies on a trick.  Normally a tab host has a simple API for supplying a View or
     * Intent that each tab will show.
     *
     * This is not sufficient（足够） for switching between pages.
     * So instead we make the content part of the tab host
     * 0dp high (it is not shown) and the TabsAdapter supplies its own dummy
     * view to show as the tab content.
     *
     * It listens to changes in tabs, and takes
     * care of switch to the correct paged in the ViewPager whenever the selected
     * tab changes.
     * tabs 监听到按钮按下，然后在ViewPager切换当前page。
     */
